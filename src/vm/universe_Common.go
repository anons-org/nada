...
func (me * OpcodeStruct) GetOper() IFObject {
	return me.oper
}
...
type NSMethodArgType struct {
	...
	arg *Utils.MethodArgAndTypeToken
	ret *Utils.MethodArgAndTypeToken
}

func (me *NSMethodArgType) GetArg() *Utils.MethodArgAndTypeToken {
	return me.arg
}

func (me *NSMethodArgType) GetRet() *Utils.MethodArgAndTypeToken {
	return  me.ret
}
...
func GetMetaKlass(k interface{}) interface{}{
	return vms.metaKlass.get(k)
}
